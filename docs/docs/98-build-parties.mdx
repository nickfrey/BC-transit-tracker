...
Some community members from outside of the Seattle metro area are organizing Transit Tracker build parties for their region. If you're organizing one (or are interested in doing so), reach out to us [on Discord](https://discord.com/invite/zhXKQ4vMp8) or [via email](mailto:friends@eastsideurbanism.org) &mdash; we can help out with logistics tips and help spread the word! And if you need us to add your local transit agency to the [supported agencies list](./02-user-manual/99-faq/agency-support.md) we can do that too.
